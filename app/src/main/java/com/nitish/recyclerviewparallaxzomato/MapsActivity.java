...
//AIzaSyBbgNyT8b2OWAxqGEwLuYGCPhlGeO52COo
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //get latitude and longitude coming from home activity
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(sydney).title("Hotel : "+restaurant));
